...
let project = "Exira.AwsS3Cache.Crawler"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.AwsS3Cache.Crawler is a task which crawls a site so pages are pre-loaded into cache"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.AwsS3Cache.Crawler is a task which crawls a site so pages are pre-loaded into cache"
...
let solutionFile  = "aws-s3-cache-crawler.sln"
...
let gitName = "aws-s3-cache-crawler"
