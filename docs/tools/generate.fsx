...
let referenceBinaries = [ "aws-s3-cache-crawler\\aws-s3-cache-crawler.exe" ]
// Web site location for the generated documentation
let website = "/aws-s3-cache-crawler"

let githubLink = "http://github.com/exira/aws-s3-cache-crawler"

// Specify more information about your project
let info =
  [ "project-name", "aws-s3-cache-crawler"
    "project-author", "exira"
    "project-summary", "Exira.AwsS3Cache.Crawler is a task which crawls a site so pages are pre-loaded into cache"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.AwsS3Cache.Crawler" ]
